% load in the image and turn it into grayscale
load 'C:\Users\ZhicongLiang\Desktop\project-1\data_cifar\cifar-10-batches-mat\data_batch_1.mat'
x = double(rgb2gray(reshape(data(2,:),[32,32,3]))');
imagesc(x);
colormap gray;
